            ...
            <nav class="navbar" data-navbar>
                ...
                <ul class="navbar-list">
                    ...
                    <li class="navbar-item">
                        <a href="operator_beranda.php" class="navbar-link" data-nav-link>Home</a>
                    </li>
                    ...
                    <ul class="grid-list">
                        ...
                        <li>
                            <div class="service-card" style="--color: 267, 76%, 57%">
                                ...
                                <h3 class="h3">
                                    <a href="table_mhsba.php" class="card-title">Lihat Mahasiswa Baitul Arqom (BA)</a>
                                </h3>
                        ...
                        <li>
                            <div class="service-card" style="--color: 17, 100%, 68%">
                                ...
                                <h3 class="h3">
                                    <a href="grade_bamhs.php" class="card-title"> Input Nilai Baitul Arqom (BA)</a>
                                </h3>
