...
if (!isset($_SESSION['user_id']) || $_SESSION['role'] != 'mahasiswa') {
    //jika pengguna bukan admin , diaarahkan ke halaman no_acces.php yang berisi tombol logout.
    ...
    -->
            ...
            <section class="section service" id="service" aria-label="service">
                <div class="container">
                    ...
                    <h2 class="h2 section-title text-center">Program Pelayanan Mahasiswa</h2>
                    ...
                    <ul class="grid-list">
                        ...
                        <li>
                            <div class="service-card" style="--color: 174, 77%, 50%">
                                ...
                                <h3 class="h3">
                                    <a href="/ba" class="card-title">Bimbingan Baca Al-Qur'an (BBA)</a>
                                </h3>
                        ...
                        <li>
                            <div class="service-card" style="--color: 17, 100%, 68%">
                                ...
                                <h3 class="h3">
                                    <a href="../front_end/ba_mahasiswa.php" class="card-title">Baitul Arqam (BA)</a>
                                </h3>
